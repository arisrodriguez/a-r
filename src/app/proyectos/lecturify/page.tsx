...
export default function LecturifyPage() {
    return (
        <main className="max-w-[700px] mx-auto px-8 py-8 mt-16">
            <h1 className="text-3xl font-bold text-neutral-800 dark:text-gray-100">Lecturify</h1>
            ...
            <div className="text-gray-600 mt-4 space-y-4">
                <h2 className="text-xl font-semibold  text-neutral-900 dark:text-gray-100">¿Porque hice este proyecto?</h2>
