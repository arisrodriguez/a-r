...
export default function HermesPage() {
    return (
        <main className="max-w-[700px] mx-auto px-8 py-8 mt-20">
            ...
            <div className="my-6">
                <img src="/images/portada-hermes.webp" alt="Banner de Hermes" className="rounded-lg shadow-md" />
            </div>

            <div className="text-gray-600 mt-4 space-y-4">
                <h2 className="text-xl font-semibold  text-neutral-900">¿Cómo nació esta idea?</h2>
                <p>
            ...
            <div className="flex flex-wrap gap-4 mt-6">
                ...
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex gap-2 items-center px-4 py-2 bg-neutral-900 text-white rounde rounded hover:bg-neutral-800 hover:scale-105 transition-all duration-300 ease-in-out"
                >
